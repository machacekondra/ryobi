...
| # | Title | Scope |
|---|-------|-------|
| [001](001-architecture-overview.md) | Architecture Overview | Single binary, no K8s, flat REST API |
...
| [005](005-async-operations.md) | Async Operations | Queue-based async for Terraform operations |
